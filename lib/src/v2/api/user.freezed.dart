...
GetUserDetailsResponse _$GetUserDetailsResponseFromJson(
  ...
  return _GetUserDetailsResponse.fromJson(json);
}

/// @nodoc
class _$GetUserDetailsResponseTearOff {
  const _$GetUserDetailsResponseTearOff();

// ignore: unused_element
  _GetUserDetailsResponse call(
    ...
    return _GetUserDetailsResponse(
      userView: userView,
      follows: follows,
      moderates: moderates,
      comments: comments,
...
// ignore: unused_element
  GetUserDetailsResponse fromJson(Map<String, Object> json) {
    return GetUserDetailsResponse.fromJson(json);
  }
}

/// @nodoc
// ignore: unused_element
const $GetUserDetailsResponse = _$GetUserDetailsResponseTearOff();

/// @nodoc
mixin _$GetUserDetailsResponse {
  ...
  Map<String, dynamic> toJson();
  $GetUserDetailsResponseCopyWith<GetUserDetailsResponse> get copyWith;
}

/// @nodoc
abstract class $GetUserDetailsResponseCopyWith<$Res> {
  factory $GetUserDetailsResponseCopyWith(GetUserDetailsResponse value,
          $Res Function(GetUserDetailsResponse) then) =
      _$GetUserDetailsResponseCopyWithImpl<$Res>;
  $Res call(
...
/// @nodoc
class _$GetUserDetailsResponseCopyWithImpl<$Res>
    implements $GetUserDetailsResponseCopyWith<$Res> {
  _$GetUserDetailsResponseCopyWithImpl(this._value, this._then);

  final GetUserDetailsResponse _value;
  // ignore: unused_field
  final $Res Function(GetUserDetailsResponse) _then;
...
/// @nodoc
abstract class _$GetUserDetailsResponseCopyWith<$Res>
    implements $GetUserDetailsResponseCopyWith<$Res> {
  factory _$GetUserDetailsResponseCopyWith(_GetUserDetailsResponse value,
          $Res Function(_GetUserDetailsResponse) then) =
      __$GetUserDetailsResponseCopyWithImpl<$Res>;
  @override
  $Res call(
      {UserViewSafe userView,
      List<CommunityFollowerView> follows,
...
/// @nodoc
class __$GetUserDetailsResponseCopyWithImpl<$Res>
    extends _$GetUserDetailsResponseCopyWithImpl<$Res>
    implements _$GetUserDetailsResponseCopyWith<$Res> {
  __$GetUserDetailsResponseCopyWithImpl(_GetUserDetailsResponse _value,
      $Res Function(_GetUserDetailsResponse) _then)
      : super(_value, (v) => _then(v as _GetUserDetailsResponse));

  @override
  _GetUserDetailsResponse get _value => super._value as _GetUserDetailsResponse;
  ...
  $Res call({
    ...
    return _then(_GetUserDetailsResponse(
      userView:
          userView == freezed ? _value.userView : userView as UserViewSafe,
      follows: follows == freezed
          ? _value.follows
...
/// @nodoc
class _$_GetUserDetailsResponse extends _GetUserDetailsResponse {
  _$_GetUserDetailsResponse(
  ...
  factory _$_GetUserDetailsResponse.fromJson(Map<String, dynamic> json) =>
      _$_$_GetUserDetailsResponseFromJson(json);
  ...
  @override
  String toString() {
    return 'GetUserDetailsResponse(userView: $userView, follows: $follows, moderates: $moderates, comments: $comments, posts: $posts)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _GetUserDetailsResponse &&
  ...
  @override
  _$GetUserDetailsResponseCopyWith<_GetUserDetailsResponse> get copyWith =>
      __$GetUserDetailsResponseCopyWithImpl<_GetUserDetailsResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$_$_GetUserDetailsResponseToJson(this);
  }
}

abstract class _GetUserDetailsResponse extends GetUserDetailsResponse {
  _GetUserDetailsResponse._() : super._();
  factory _GetUserDetailsResponse(
      {@required UserViewSafe userView,
      @required List<CommunityFollowerView> follows,
      @required List<CommunityModeratorView> moderates,
      @required List<CommentView> comments,
      @required List<PostView> posts}) = _$_GetUserDetailsResponse;

  factory _GetUserDetailsResponse.fromJson(Map<String, dynamic> json) =
      _$_GetUserDetailsResponse.fromJson;
...
/// @nodoc
class _$BanUserResponseTearOff {
  const _$BanUserResponseTearOff();

// ignore: unused_element
  _BanUserResponse call(
      {@required UserViewSafe userView, @required bool banned}) {
    return _BanUserResponse(
      userView: userView,
      banned: banned,
    );
  }
...
// ignore: unused_element
  BanUserResponse fromJson(Map<String, Object> json) {
    return BanUserResponse.fromJson(json);
  }
}

/// @nodoc
// ignore: unused_element
const $BanUserResponse = _$BanUserResponseTearOff();
...
abstract class $BanUserResponseCopyWith<$Res> {
  factory $BanUserResponseCopyWith(
      ...
      _$BanUserResponseCopyWithImpl<$Res>;
...
/// @nodoc
class _$BanUserResponseCopyWithImpl<$Res>
    implements $BanUserResponseCopyWith<$Res> {
  _$BanUserResponseCopyWithImpl(this._value, this._then);

  final BanUserResponse _value;
  // ignore: unused_field
  final $Res Function(BanUserResponse) _then;
...
/// @nodoc
abstract class _$BanUserResponseCopyWith<$Res>
    implements $BanUserResponseCopyWith<$Res> {
  factory _$BanUserResponseCopyWith(
          _BanUserResponse value, $Res Function(_BanUserResponse) then) =
      __$BanUserResponseCopyWithImpl<$Res>;
  @override
  $Res call({UserViewSafe userView, bool banned});
...
/// @nodoc
class __$BanUserResponseCopyWithImpl<$Res>
    extends _$BanUserResponseCopyWithImpl<$Res>
    implements _$BanUserResponseCopyWith<$Res> {
  __$BanUserResponseCopyWithImpl(
      _BanUserResponse _value, $Res Function(_BanUserResponse) _then)
      : super(_value, (v) => _then(v as _BanUserResponse));

  @override
  _BanUserResponse get _value => super._value as _BanUserResponse;
...
/// @nodoc
class _$_BanUserResponse extends _BanUserResponse {
  _$_BanUserResponse({@required this.userView, @required this.banned})
      : assert(userView != null),
        assert(banned != null),
        super._();

  factory _$_BanUserResponse.fromJson(Map<String, dynamic> json) =>
      _$_$_BanUserResponseFromJson(json);
  ...
  @override
  String toString() {
    return 'BanUserResponse(userView: $userView, banned: $banned)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _BanUserResponse &&
            (identical(other.userView, userView) ||
                const DeepCollectionEquality()
                    .equals(other.userView, userView)) &&
  ...
  @override
  _$BanUserResponseCopyWith<_BanUserResponse> get copyWith =>
      __$BanUserResponseCopyWithImpl<_BanUserResponse>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$_$_BanUserResponseToJson(this);
  }
}

abstract class _BanUserResponse extends BanUserResponse {
  _BanUserResponse._() : super._();
  factory _BanUserResponse(
      {@required UserViewSafe userView,
      @required bool banned}) = _$_BanUserResponse;
